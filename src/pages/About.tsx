      ...
      <section className="mx-auto max-w-[1320px] px-10 pt-[140px] pb-20 max-[900px]:px-[22px] max-[900px]:pt-[100px] max-[560px]:pt-[92px]">
        ...
        <div className="pt-20">
          <div className="mb-2 flex items-baseline justify-between border-b border-line pb-[14px]">
            <span className="text-[11px] uppercase tracking-[0.11em] text-muted">Skills</span>
        ...
        <div className="pt-20">
          <div className="mb-2 flex items-baseline justify-between border-b border-line pb-[14px]">
            <span className="text-[11px] uppercase tracking-[0.11em] text-muted">Experience</span>
        ...
        <div className="pt-20">
          <div className="mb-2 flex items-baseline justify-between border-b border-line pb-[14px]">
            <span className="text-[11px] uppercase tracking-[0.11em] text-muted">Education</span>
        ...
        <div className="pt-20">
          <div className="mb-2 flex items-baseline justify-between border-b border-line pb-[14px]">
            <span className="text-[11px] uppercase tracking-[0.11em] text-muted">Licenses & Awards</span>
